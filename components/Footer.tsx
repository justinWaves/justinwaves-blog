...
function Footer() {
  return (
    <div className="bg-slate-200 flex flex-col ">
      <Link href="/">
        <svg
          className="w-64 md:w-30  object-contain cursor-pointer fill-slate-300 hover:animate-pulse hover:fill-slate-700 mx-auto -mb-12 md:-mb-20 mt-20 "
      ...
      <div className="h-1/3 bg-black p-20 flex flex-row justify-between ">
        <div className="flex flex-row  ">
          <h1 className=" text-slate-300 text-2xl mr-10 animate-pulse">
            join mailing list
          </h1>
          <div className="flex flex-col space-x-2 w-1.3 ">
            <form action="">
              <input
                type="text"
                className="decoration-white h-10 w-full text-2xl p-2 rounded-md"
              />
              <button className="text-lg text-slate-200 h-10 w-full bg-slate-700 mt-2 rounded-md">
                send
              </button>
            </form>
          </div>
        ...
        <div className="flex flex-col ">
          <img
            className=" w-20 object-contain mx-auto  hidden md:block"
