...
function Header() {
  return (
    <header
     ...
     p-3  mx-auto max-w-7xl  bg-[#141C2F] w-screen z-10 left-0 right-0 bg-filter backdrop-blur-xl bg-opacity-90 z-15 md:rounded-br-md"
    >
      ...
      <div className="w-fill absolute mx-auto left-0 right-0 flex justify-center">
        <h1 className="text-white font-thin text-md pr-3 mt-4">JUSTIN</h1>
          ...
          <RoundLogoSvg className="fill-sky-100 w-14 hover:fill-[#CC8470] hover:animate-pulse cursor-pointer"/>
